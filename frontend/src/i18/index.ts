...
const ES_MESSAGES = {
  ...
  holdOptionTodayTime: "Hoy a una hora...",
  holdTimePickerAria: "Selector de hora para reposo",
  holdTimeInputLabel: "Hora",
  holdTimeCancel: "Cancelar",
  holdTimeConfirm: "Aceptar",
  holdTodayPrompt: "Introduce una hora para hoy (HH:MM)",
  holdInvalidTime: "Hora invalida. Usa formato HH:MM.",
  holdPastTime: "La hora debe ser futura y del dia de hoy.",
...
const EN_MESSAGES: MessageCatalog = {
  ...
  holdOptionTodayTime: "Today at a specific time...",
  holdTimePickerAria: "Time selector for hold",
  holdTimeInputLabel: "Time",
  holdTimeCancel: "Cancel",
  holdTimeConfirm: "Apply",
  holdTodayPrompt: "Enter a time for today (HH:MM)",
  holdInvalidTime: "Invalid time. Use HH:MM format.",
  holdPastTime: "Time must be in the future and for today.",
