...
const ES_MESSAGES = {
  ...
  taskAlreadyCreating: "Ya hay una tarea en creación",
  cancelNewTask: "Cerrar nueva tarea",
  settings: "Configuración",
  settingsMenuAria: "Configuración de la aplicación",
  ...
  enterHint: "Enter ↵",
  emptyState: "No hay tareas aún. Haz clic en + para crear una.",
  priorityHigh: "Alta",
  ...
  holdOptionTomorrow: "Hasta mañana (08:00)",
  holdOptionIndefinite: "Indefinida",
  holdOptionTodayTime: "A una hora concreta...",
  holdTimePickerAria: "Selector de hora de reactivación",
  holdTimeInputLabel: "Reactivar a las",
  holdTimeCancel: "Cancelar",
  holdTimeConfirm: "Aceptar",
  holdTodayPrompt: "Introduce una hora de reactivación (HH:MM)",
  holdInvalidTime: "Hora inválida. Usa formato HH:MM.",
